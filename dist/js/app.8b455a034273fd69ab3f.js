...
module.exports = {"dashboard":{"buyingTable":"Comprando BTC a través de Lightning"},"editProfile":{"alerts":{"failedSavedProfile":"Error al guardar el perfil","savedProfile":"Perfil Guardado"},"editProfile":"Editar Perfil"},"followingList":{"alerts":{"failureToRemove":"Falta de eliminación","removed":"Remoto","removedUser":"Usuario eliminado de la siguiente lista"},"followingList":"Lista de seguidores","unfollowUser":"¿Estás seguro de que quieres dejar de seguir a este usuario?"},"general":{"aboutMe":"Sobre Mí","actions":"Comportamiento","buying":"Comprando","capacity":"Capacidad","city":"Ciudad","country":"País","currency":"Moneda","description":"Descripción","email":"Email","follow":"Seguir","location":"Ubicación","logOut":"Cerrar Sesión","name":"Nombre","nodeInformation":"Información del nodo","profile":"Perfil","removed":"Remoto","save":"Salvar","search":"Buscar","selling":"De Venta","settings":"Ajustes","signIn":"Registrarse","state":"Estado","username":"Nombre de usuario"},"home":{"invoiceModal":{"connectToLightningNode":"Conéctate al Nodo Relámpago de LocalLightning","savedPayInvoice":"Guardados en el almacenamiento del usuario, pagar factura para publicar en el feed de listado"},"notify":{"deletedListing":"Listado borrado","deletedListingFailed":"Error al eliminar la lista","error":"Error","errorSavingUserStorage":"Error al guardar la lista en el almacenamiento del usuario","invoicePaid":"Factura pagada","invoicePaidDesc":"Listado publicado en el feed de listado","listingDiscarded":"Listado Descartado","listingSaved":"Listado guardado","listingSavedToYourStorage":"Listado guardado en su almacenamiento"},"search":{"city":"Buscar ciudad","country":"Buscar pais","state":"Estado de búsqueda"},"table":{"buyingTable":"Comprando BTC","listingType":"Tipo de listado","postBuyListing":"Publicar listado de compra","postSellListing":"Publicar anuncio de venta","sellingTable":"Vendiendo BTC"},"welcome":{"getStarted":"Empezar","header":"Bienvenido a Local Lightning!","learnMore":"Para aprender más sobre la red Lightning, por favor, echa un vistazo a","optionallyConnectToNode":"Opcionalmente, conecte al Nodo de Rayo Local","paragraph1":"Local Lightning fue creado para conectar a aquellos que desean vender o comprar bitcoin localmente.","paragraph2":"Al utilizar Lightning Network sobre Bitcoin, los usuarios pueden aprovechar el envío y la recepción instantáneos de Bitcoin sin la necesidad de esperar los tiempos de confirmación.","paragraph3":"A diferencia de sitios web similares, Local Lightning nunca retiene ni administra los fondos de los usuarios.","thisArticle":"este artículo."}},"profile":{"alerts":{"alreadyFollowingUser":"Ya Siguiendo Usuario","failureDeleteListing":"Error al eliminar la lista del servidor","failureDeleteListingUser":"Error al eliminar la lista de su almacenamiento","failureFollowingUser":"Error al seguir al usuario","followingUser":"Siguiente usuario","removedListing":"Listado eliminado","userNotFound":"Usuario no encontrado"},"deleteListing":"¿Estás seguro de que quieres eliminar esta lista?"},"sidebar":{"dashboard":"Tablero","following":"Siguiendo","icons":"Iconos","listings":"Listados","notifications":"Notificaciones","rtlSupport":"Soporte RTL","settings":"Ajustes","tableList":"Lista de tablas","userProfile":"Perfil del usuario"}}
...
//# sourceMappingURL=app.8b455a034273fd69ab3f.js.map