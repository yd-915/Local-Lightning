...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_radiks__ = __webpack_require__(46);
  ...
  methods: {
    ...
    acceptAlert: function acceptAlert() {
      ...
      listing.save().then(function (result) {
        console.log(result);
        _this5.notifySuccess('Listing Saved');
    ...
    acceptAlertInvoice: function acceptAlertInvoice() {
      ...
      listing.saveLN().then(function (result) {
        console.log(result);
        _this6.notifySuccess('Saved Listing', 'Listing saved to your storage');
        ...
        console.log('error saving listing: ' + error);
        _this6.$vs.loading.close();
        _this6.notifyFailure('Did not save Listing', 'Error saving listing to user\'s storage');
      });
    },
    ...
    deleteListing: function deleteListing(listing) {
      ...
      listing.destroy().then(function () {
        _this7.notifySuccess('Deleted Listing', null);
        _this7.loadListings();
      }).catch(function (error) {
        logger.info('failed to delete listing: ' + error);
        _this7.notifyFailure('Failed To Delete Listing', null);
      });
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("Log out")])])]) : _vm._e()], 1)])]), _vm._v(" "), (!_vm.signedIn) ? _c('button', {
    staticClass: "btn btn-default",
    on: {
      "click": function($event) {
        $event.preventDefault();
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', [_c('div', {
    ...
    }, [_vm._v("Optionally connect to Local Lightning's Node")])]), _vm._v(" "), _c('div', {
      staticClass: "text-center"
    }, [_c('base-button', {
      staticClass: "my-4",
      attrs: {
...
//# sourceMappingURL=app.e7b4de839f466d897af7.js.map