  ...
  methods: {
    ...
    acceptAlert: function acceptAlert() {
      ...
      listing.saveLN().then(function (result) {
        ...
        __WEBPACK_IMPORTED_MODULE_1__assets_models_Listing__["a" /* default */].addInvoiceStreamListener(result.id, _this5.newLNListener);
        _this5.listing = listing;
        _this5.invoice = result;
        _this5.saveListingToUser(_this5.listing);
        _this5.$vs.loading.close();
...
//# sourceMappingURL=app.95569ae52b7ec86c0f29.js.map